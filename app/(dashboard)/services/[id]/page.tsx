  ...
  useEffect(() => {
    ...
    const fetchService = async () => {
      ...
      setFormData({
        ...
        approved_places: data.approved_places?.toString() || '',
        current_occupancy: data.current_occupancy?.toString() || '',
        years_operating: data.years_operating?.toString() || '',
        last_rating: data.last_rating || '',
        last_rating_date: data.last_rating_date || '',
      });
    };
